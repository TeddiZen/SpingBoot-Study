...
//        String bucketName = generateUniqueBucketName("teddizen-java-tesy");
        String bucketName = "teddizen-java-tesy";
...
//            System.out.println("1. Bucket " + bucketName + " 创建成功。");
            ...
            File imageFile = new File("E:\\code\\SpringBoot-Study\\Tlias-Test\\src\\main\\resources\\static\\imagetest1.png");
